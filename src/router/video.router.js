...
videoRouter.post('/', mediaMutationMaintenance, verifyAuth, videoHandler, videoController.saveVideoInfo);

// ★关联视频到文章接口
// POST /video/:articleId
// 用于发布/编辑文章时，将上传的视频与文章关联
videoRouter.post('/:articleId', mediaMutationMaintenance, verifyAuth, videoController.updateVideoArticle);

// ★删除视频接口
// DELETE /video
// 删除视频文件及其数据库记录（包括封面图）
videoRouter.delete('/', mediaMutationMaintenance, verifyAuth, videoController.deleteVideo);
